...
const Work: React.FC = () => {
  return (
    <>
      <div className="flex flex-col items-center justify-center w-full min-h-screen bg-black text-white pt-[120px] pb-10">
          ...
          <div className="flex flex-col md:flex-row gap-8 items-start">
            ...
            <div className="w-full md:w-1/2 bg-black-100 rounded-lg p-6 shadow-lg">
              <div className="instagram-container">
                <InstagramProfileEmbed profileUrl={instagramProfileUrl} />
              </div>
            </div>
